<div class="container">
    ...
    <div class="form-group <?= $this->Form->isFieldError('User.name') ? 'has-error has-feedback' : ''; ?>">
        ...
        <div class="col-sm-8">
            <?= $this->Form->input('name', array('class' => 'form-control', 'placeholder' => __('Name'), 'id' => 'inputName', 'required' => false)); ?>
            <?php
    ...
    <div class="form-group <?= $this->Form->isFieldError('User.email') ? 'has-error has-feedback' : ''; ?>">
        ...
        <div class="col-sm-8">
            <?= $this->Form->input('email', array('class' => 'form-control', 'placeholder' => __('Email'), 'id' => 'inputEmail', 'required' => false)); ?>
            <?php
    ...
    <div class="form-group <?= $this->Form->isFieldError('User.username') ? 'has-error has-feedback' : ''; ?>">
        <label for="inputUser" class="col-sm-2 control-label"><?= __('Username'); ?></label>
        <div class="col-sm-8">
    ...
    <div class="form-group">
        <div class="col-sm-offset-2 col-sm-10">
            <?= $this->Form->end(array('label' => __('Save'), 'class' => 'btn btn-default')); ?>
        </div>
    </div>
</div>