...
<div class="container">
    <div class="page-header">
        <h1><?= __d('system','Users'); ?></h1>
        <p><?= __d('system','Edit, Reset, Delete and check out the users registered in your app.'); ?></p>
    </div>
    <?= $this->HTML->link(__d('system','Add new user'), array('plugin' => 'system','controller' => 'users','action' => 'add'), array('class' => 'btn btn-success')); ?>
    <hr/>
    <div class="row">
        ...
        <div class="col-sm-2 text-right">
            <p>
            <span class="tooltipElement" data-toggle="tooltip" data-original-title="<?= __d('system','Filter posts') ?>"><?= $this->Html->link($this->Form->button('<i class="fa fa-filter"></i> ' . __d('system','Filter'), array('type'=>'submit')), array('plugin' => 'system','controller' => 'users', 'action' => 'index'), array("escape" => false)) ?></span>
            </p>
            <span class="tooltipElement" data-toggle="tooltip" data-original-title="<?= __d('system','Reset filter') ?>"><?= $this->Html->link($this->Form->button('<i class="fa fa-trash-o"></i> ' . __d('system','Reset'), array('type'=>'button')), array('plugin' => 'system','controller' => 'users', 'action' => 'index'), array("escape" => false)) ?></span>
        </div>
    </div>
    <hr/>
